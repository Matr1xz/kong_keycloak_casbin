...
Write-Host "  Admin: admin_user / Adm1n@CyberLabX#9914" -ForegroundColor Green
Write-Host "  User:  test_user / T3st@CyberLabX#3362" -ForegroundColor Green
Write-Host ""
