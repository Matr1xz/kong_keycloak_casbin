...
| Service                  | Username    | Password                 | Mô tả                        |
|--------------------------|-------------|--------------------------|-------------------------------|
| Kong PostgreSQL           | `kong`      | `K0ng_Db@Secure#8821`    | DB nội bộ của Kong Gateway    |
| Keycloak PostgreSQL       | `keycloak`  | `Kc_Db@Secure#5537`      | DB nội bộ của Keycloak        |
| Keycloak Admin Console    | `kcadmin`   | `KcAdm1n@CyberX#7743`   | Đăng nhập tại `/admin`        |

## 👤 Test Users (Keycloak realm: cyberlabx)

| Username     | Password                | Role  |
|--------------|-------------------------|-------|
| `admin_user` | `Adm1n@CyberLabX#9914` | admin |
| `test_user`  | `T3st@CyberLabX#3362`  | user  |
